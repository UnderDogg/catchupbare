...
<div class="form-group">
    <label for="category">{!! trans('admin/staff/general.columns.permissions-not-found') !!}</label>
...
<div class="form-group">
    <label for="category">{!! trans('admin/staff/general.columns.roles') !!}</label>
...
<div class="form-group">
    <label for="category">{!! trans('admin/staff/general.columns.roles-not-found') !!}</label>
