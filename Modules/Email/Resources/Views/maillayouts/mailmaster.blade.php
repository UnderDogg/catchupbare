...
<!-- <header class="main-header"> -->
            ...
            <ul id="side-bar" class="sidebar-menu">
                ...
                <li class="treeview @yield('Mailboxes')">
                    ...
                    <ul class="treeview-menu">
                        <li @yield('allmailboxes')><a href="{{ url('/mailpanel/mailboxes/manage') }}"><i
        ...
        <div class="tab-content" style="background-color: white;padding: 0 20px 0 20px">
            ...
            <footer class="main-footer">
                ...
                <strong>{!! Lang::get('lang.copyright') !!} &copy; {!! date('Y') !!}  <a href="#" target="_blank">CompanyName</a>.</strong> {!! Lang::get('lang.all_rights_reserved') !!}. {!! Lang::get('lang.powered_by') !!} <a href="http://www.faveohelpdesk.com/" target="_blank">Faveo</a>
            </footer>
        </div><!-- ./wrapper -->
