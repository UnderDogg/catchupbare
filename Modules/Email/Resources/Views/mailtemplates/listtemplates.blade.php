                    ...
                    @if(Session::has('success'))
                        ...
                        <table id="example1" class="table table-bordered table-striped">
                            <tr>
                                ...
                                <th>{{Lang::get('email::lang.description')}}</th>
                            </tr>
                            ...
                            @foreach($templates as $template)
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="{{route('template.read',[$template,$directory])}}"><?php $parts = explode('.', $template); $names = $parts[0]; $name = str_replace('-', ' ', $names); $cname = ucfirst($name); echo $cname?></a>
                                    </td>
                                    <td>{{ Lang::get('email::lang.'.$cname) }}</td>
