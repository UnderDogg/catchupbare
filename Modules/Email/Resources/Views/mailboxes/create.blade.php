...
@section('Mailboxes')
    ...
    @stop
            <!-- header -->
@section('PageHeader')
    <h1>{{Lang::get('email::lang.add_a_mailbox')}}</h1>
    @stop
            <!-- /header -->
    <!-- breadcrumbs -->
@section('breadcrumbs')
    ...
    <form id="form">
        <div class="box box-primary">
            ...
            <div class="box-body">
                <div class="row">
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 form-group">
                            ...
                            <input type="checkbox" checked='checked' name="fetching_status"
                                   id="fetching_status"> {{Lang::get('email::lang.enable')}}
                        </div>
                        <div class="col-xs-2 form-group">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-4 form-group">
                        ...
                        <br/><br/>
                        <input type="checkbox" name="validate" value="/novalidate-cert" id="validate">&nbsp; Validate certificates from TLS/SSL
                        server
                    </div>
                </div>
            </div>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-xs-2 form-group">
                            <input type="checkbox" name="sending_status"
                                   id="sending_status"> {!! Lang::get('email::lang.enable') !!}
                        </div>
                        <div class="col-xs-2 form-group">
            ...
            <div class="box-footer">
                {!! Form::button('<i id="spin" class="fa fa-spinner" style="display:none;"></i> <b>' . Lang::get("core::lang.create").'</b>' ,['class'=>'btn btn-primary', 'type' => 'submit'])!!}
