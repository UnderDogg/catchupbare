...
<div class="box box-primary">
    <div class="box-header with-border">
        <h3 class="box-title">{{Lang::get('core::lang.cron_settings')}}</h3>
    </div>
...
<!--        <div class="alert  alert-dismissable" style="background: #F3F3F3">
        ...
        <div class="alert  alert-dismissable" style="background: #F3F3F3">
            <i class="fa  fa-info-circle"></i>&nbsp;{!!Lang::get('core::lang.cron-url-message')!!}
                ...
                <div class="info-box-content">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            {!! Form::checkbox('email_fetching',1,$condition->checkActiveJob()['fetching'],['id'=>'email_fetching']) !!}&nbsp;{{Lang::get('core::lang.fetch_auto-cron')}}
                        </div>
        ...
        <div class="col-md-6">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('notification_cron',Lang::get('core::lang.notification-email')) !!}<br>
                            {!! Form::checkbox('notification_cron',1,$condition->checkActiveJob()['notification'],['id'=>'notification_cron']) !!}&nbsp;{{Lang::get('core::lang.cron_notification')}}
                        </div>
                    </div>
        ...
        <div class="col-md-6">
            <div class="info-box">
                ...
                <div class="info-box-content">
                    <div class="col-md-6">
                        <div class="form-group">
                            {!! Form::label('condition',Lang::get('core::lang.auto_close_workflow')) !!}<br>
                            {!! Form::checkbox('condition',1,$condition->checkActiveJob()['work'],['id'=>'auto_close']) !!}
                                   {{Lang::get('core::lang.enable_workflow')}}
                        </div>
                    </div>
    ...
    <div class="box-footer">
        {!! Form::submit(Lang::get('core::lang.submit'),['class'=>'btn btn-primary'])!!}
    </div>
</div>
<script>
