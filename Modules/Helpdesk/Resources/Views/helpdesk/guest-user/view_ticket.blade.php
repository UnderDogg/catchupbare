...
<?php $assignedto = Modules\Core\Models\Staff::where('id', '=', $tickets->assigned_to)->first();?>
                    ...
                    <div id="hide2">
                        <div class="col-md-6">
                            <table class="table table-hover" id="refresh">
                                <tr>
                                    <td><b>Status:</b></td>
                                    <div><?php $status = Modules\Tickets\Models\TicketStatus::where('id', '=', $tickets->status)->first();?>
                                        <td title="{{$status->properties}}">{{$status->name}}</td>
                                    </div>
                                </tr>
                                <tr>
                                    <td><b>Priority:</b>
                                    </td> <?php $priority = Modules\Tickets\Models\TicketPriority::where('id', '=', $tickets->priority_id)->first();?>
                                    <td title="{{$priority->priority_desc}}">{{$priority->priority_desc}}</td>
                                </tr>
                                <tr>
                                    <td><b>Department:</b>
                                    </td> <?php $help_topic = Modules\Tickets\Models\HelpTopic::where('id', '=', $tickets->help_topic_id)->first();?>
