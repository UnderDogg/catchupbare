...
@section('breadcrumb')
    <div class="site-hero clearfix">
        <ol class="breadcrumb breadcrumb-custom">
            <li class="text">{!! Lang::get('helpdesk::lang.you_are_here') !!}: </li>
            <li><a href="#">{!! Lang::get('helpdesk::lang.home') !!}</a></li>
            <li class="active">{!! Lang::get('helpdesk::lang.ticket_status') !!}</li>
        </ol>
    </div>
@stop	
                            ...
                            <div class="pull-right">
                                ...
                                <div class="btn-group"> 
                                    <button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown"><i class="fa fa-exchange" style="color:teal;"> </i> 
                                        {!! Lang::get('helpdesk::lang.change_status') !!} <span class="caret"></span>
                                    </button>
                                    <ul class="dropdown-menu">
                                        <li><a href="#" id="open"><i class="fa fa-folder-open" style="color:#FFD600;"> </i>{!! Lang::get('helpdesk::lang.open') !!}</a></li>
                                        <li><a href="#" id="close"><i class="fa fa-check" style="color:#15F109;"> </i>{!! Lang::get('helpdesk::lang.close') !!}</a></li>
                                        <li><a href="#" id="resolved"><i class="fa fa-check-circle " style="color:#0EF1BE;"> </i> {!! Lang::get('helpdesk::lang.resolved') !!}</a></li>
                                    </ul>
                                </div>
                                {!! Form::close() !!}
                            </div>
                                    ...
                                    <div class="col-md-12"> 
                                        ...
                                        <div class="callout callout-default ">
                                            <div class="row">
                                                ...
                                                <div class="col-md-3"> 
                                                    <b>{!! Lang::get('helpdesk::lang.created_date') !!}: </b> {{ UTC::usertimezone($tickets->created_at) }}
                                                </div>
                                                <div class="col-md-3"> 
                                                    <b>{!! Lang::get('helpdesk::lang.due_date') !!}: </b>
                                                    <?php 
                                                ...
                                                @endforeach
                                                    <b>{!! Lang::get('helpdesk::lang.last_response') !!}: </b> {{ UTC::usertimezone($ResponseDate)}}
                                                </div>
                                            </div>
                                        </div>
                                    </div>      
...
<div id="respond" class="comment-respond form-border">
    ...
    @endif
        ...
        <div class="text-right">
            <button type="submit" class="btn btn-custom btn-lg">{!! Lang::get('helpdesk::lang.post_comment') !!}</button>
        </div>
    {!! Form::close() !!}
</div>
