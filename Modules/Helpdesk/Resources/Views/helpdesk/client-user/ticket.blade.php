                        ...
                        <div id="hide2">
                            <div class="col-md-6">
                                <table class="table table-hover" id="refresh">
                                    ...
                                    <tr>
                                        <td><b>Priority:</b>
                                        </td> <?php $priority = Modules\Tickets\Models\TicketPriority::where('id', '=', $ticket->priority_id)->first();?>
                                        <td title="{{$priority->priority_desc}}">{{$priority->priority_desc}}</td>
                                    </tr>
                                    <tr>
                                        <td><b>Department:</b>
                                        </td> <?php $help_topic = Modules\Tickets\Models\HelpTopic::where('id', '=', $ticket->help_topic_id)->first();?>
                            ...
                            <div class="col-md-6">
                                ...
                                <table class="table table-hover">
                                    ...
                                    <tr>
                                        <td><b>Status:</b></td>
                                        <div><?php $status = App\Model\Ticket\Ticket_Status::where('id', '=', $ticket->status_id)->first();?>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-footer" style="margin-bottom:-5px">
                                            ...
                                            <ul class='mailbox-attachments clearfix'>
                                                ...
                                                ob_end_clean();
                                                $var = '<a
                                                        href="'.URL::route('image', array('image_id' => $attachment->id)).'"
                                                        target="_blank"><img style="max-width:200px;height:133px;"
